...
<table border="1" class="container-fluid">
    ...
    <c:forEach items="${phoneList}" var="phoneList" >
        <tr>
            ...
            <td>${phoneList.price}</td>
            <td>${phoneList.color}</td>
            <td><a href="/phone?action=edit&id=${phoneList.id}">edit</a></td>
            <td><a href="/phone?action=delete&id=${phoneList.id}">delete</a></td>
